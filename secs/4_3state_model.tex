\subsection{3 state dynamic model assumptions}

The following assumptions are used to arrive at the three-state dynamic model\cite{devarakonda2009model}:
\begin{enumerate}
...
Where:
\begin{align*}
    R_1 &= \text{Standard SCR Reaction Rate}\\
    R_3 &= \text{Ammonia Oxidation Rate}\\
    R_{4F}, R_{4R} &= \text{Ammonia Adsorption/Desorption Rate}
\end{align*}


%===============================================================================
\input{secs/4-1_3state_theta.tex}
\input{secs/4-2_molar_storage.tex}
\input{secs/4-3_parametrization.tex}
\input{secs/4-4_urea_dyn.tex}
\input{secs/4-5_perturb_lin.tex}
